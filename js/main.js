...
class Snake {
    constructor() {
        ...
        /* Building DOM */
        $('body').append(this.$game.append(this.$space, this.$start, this.$choice.append(this.$size10.text('10'), this.$size50.text('50'), this.$size100.text('100'))));
        this.Restructure(10);
        this.RedrawSpace();
        this.Start();
    }
    ...
    Move(e) {
        ...
        switch (e.keyCode) {
            case arrow.right:
                if (this.move !== this.moves['left'])
                    this.move = this.moves['right'];
                break;
            case arrow.left:
                if (this.move !== this.moves['right'])
                    this.move = this.moves['left'];
                break;
            case arrow.up:
                if (this.move !== this.moves['down'])
                    this.move = this.moves['up'];
                break;
            case arrow.down:
                if (this.move !== this.moves['up'])
                    this.move = this.moves['down'];
                break;
        }
    }
    GameOver() {
